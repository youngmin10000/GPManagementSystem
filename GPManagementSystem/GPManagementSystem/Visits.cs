...
namespace GPManagementSystem
{
    public partial class Visits : Form
    {
        ...
        private void listBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            Visit vis = (Visit)listBox1.SelectedItem;
            textBox4.Text = vis.visit_id.ToString();
            textBox5.Text = vis.patient.ToString();
            textBox6.Text = vis.secretary.ToString();
            textBox7.Text = vis.doctor.ToString();
            textBox8.Text = vis.date.ToString();
            textBox9.Text = vis.reasons;
            textBox10.Text = vis.diagnosis;
            textBox11.Text = vis.notes;
        }
